...
public final class OpenApiAutomatorWorkflow implements AiGenWorkflow {
    ...
    public void execute() {
        if (baseCmd.helpFlag) {
            String commandUsageInfo = BLauncherCmd.getCommandUsageInfo("aigen-" + NAME, OpenApiAutomatorWorkflow.class.getClassLoader());
    ...
    public void printUsage(StringBuilder out) {
        out.append("bal aigen openapi [args...]");
    }
